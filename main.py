...
df1.loc[mask, ['rubro', 'productos']] = [sin_definir, sin_definir]
...
#Veo la cantidad de nans: cant: 5
#Pero ademas hay valores no  Nan pero definidos con "SIN DEFINIR" con str.contains
#Pero tenenemos NaN, procedemos a quitarlos,luego veremos en particular:Solo son 5
...
aux=df1.loc[df1.rubro.str.contains("SIN DEFINIR")]
#Al parecer estos registros tienen en la columna categoria_desc el valor "Comercializadores", veamos si pasa con todos los reguistros
bool1 = df1.categoria_desc.str.contains("Comercializadores")
aux1 = df1.loc[bool1]
